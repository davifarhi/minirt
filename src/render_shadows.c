...
/*   Updated: 2022/10/13 12:21:59 by mreymond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_quadratic_equation	sphere_get_quad_abc_s(
		const t_obj *obj, const t_vector *v_ray, t_coord point)
{
...
t_obj_ray_hit	*render_sphere_s(const t_obj *obj, const t_vector *v_ray, t_coord point)
{
	t_quadratic_equation	abc;
	...
	abc = sphere_get_quad_abc_s(obj, v_ray, point);
