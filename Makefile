...
#    Updated: 2022/10/05 00:08:31 by mreymond         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

FILES		= minirt

FILES_D		= mlx_setup mlx_utils colors_utils render_loop vector_rotation math_utils render_setup render_sphere render_per_pixel render_plane
