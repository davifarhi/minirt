...
#    Updated: 2022/10/18 13:58:20 by dfarhi           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

FILES		= minirt

FILES_D		= mlx_setup mlx_utils colors_utils render_loop vector_rotation math_utils render_setup render_sphere render_per_pixel render_plane render_cylinder vector_op1 vector_op2 vector_op3
